...
def set_gender():
    ...
    gender_print(actualgender)
    return(actualgender)
def gender_print(gender):
...
def adventure_death():
        chance_advdeath = chance_dice(0,4)    
        if chance_advdeath == 1:
            
            print("you died during skydiving")
            print("RIP you died while you were enjoying")
            result = 0
        elif chance_advdeath == 2:
            
            print("you died while diving from a cliff")
            print("RIP you died while you were enjoying")
            result = 0
        else:
            result = 1
...
while game_status == "alive":
   ...
   #never is late for python 
    ...
    if age >= 25 and college_message == False:
        ...
        chance_college = chance_dice(3,5)
        if chance_college == 3:
    ...
    if age >= 25 and married_message == False:
        married_message = True
        chance_married = chance_dice(3,5)
        if chance_married == 3:
    ...
    if age >= 75:
        ...
        if old_age_death == 1:
            game_status = "dead"
            natural_death()
    if age >= 25 and game_status == "alive":
        adv_death = chance_dice(0,100)
        if adv_death == 1:
            
            result = adventure_death()
            if result == 1:
                game_status = "alive"
            else:
                game_status = "dead"
